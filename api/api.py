        ...
        if ( output_params and 'basicstats' in output_params ) or not output_params:                
            ...
            for k in probe_data_output.keys():
                ...
                for p in probe_data_output[k].keys():
                    ...
                    app.logger.debug("ProbeData Min Max")
                    app.logger.debug(data_array)
                    app.logger.debug(min(data_array))
                    app.logger.debug(max(data_array))
                    app.logger.debug(mean(data_array))
